...
def arguments() -> Tuple[ArgumentParser, Namespace]:
    ...
    extract_parser.add_argument("-i", "--input", help="input file", type=FileType("rb"), required=True)
    extract_parser.add_argument("-o", "--output", help="output file", type=FileType("w"), required=True)
    extract_parser.add_argument("-v", "--verbose", help="increase output verbosity", action="store_true")
    ...
    generate_parser.add_argument("-i", "--input", help="input file", type=FileType("r"), required=True)
    generate_parser.add_argument("-o", "--output", help="output file", type=FileType("wb"), required=True)
    generate_parser.add_argument("-v", "--verbose", help="increase output verbosity", action="store_true")
